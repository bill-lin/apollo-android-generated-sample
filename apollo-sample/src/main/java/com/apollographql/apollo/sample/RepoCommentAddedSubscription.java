...
public final class RepoCommentAddedSubscription implements Subscription<RepoCommentAddedSubscription.Data, RepoCommentAddedSubscription.Data, RepoCommentAddedSubscription.Variables> {
  public static final String OPERATION_ID = "cbe4225458d091d3c451b3fc5d3f05c6630e60910652fb76f1d849b4d4f2a552";

  public static final String QUERY_DOCUMENT = "subscription RepoCommentAddedSubscription($repo: String!) {\n"
  ...
  public static final OperationName OPERATION_NAME = new OperationName() {
    @Override
    public String name() {
      return "RepoCommentAddedSubscription";
    }
  };

  private final Variables variables;

  public RepoCommentAddedSubscription(@NotNull String repo) {
    Utils.checkNotNull(repo, "repo == null");
    variables = new Variables(repo);
  }
  ...
  public static final class Builder {
    ...
    public RepoCommentAddedSubscription build() {
      Utils.checkNotNull(repo, "repo == null");
      return new RepoCommentAddedSubscription(repo);
    }
  }
  ...
  public static class Data implements Operation.Data {
    ...
    final @Nullable CommentAdded commentAdded;
     ...
     */
    public @Nullable CommentAdded commentAdded() {
    ...
    public ResponseFieldMarshaller marshaller() {
      return new ResponseFieldMarshaller() {
        ...
        public void marshal(ResponseWriter writer) {
          writer.writeObject($responseFields[0], commentAdded != null ? commentAdded.marshaller() : null);
        }
      };
    }
